...
// Esta página é a de "Calçados" (categoria fixa = 1).
// Se o usuário marcar categorias no filtro, elas restringem ainda mais
// dentro dessa categoria fixa (ex.: subcategorias de calçados).
$condicoes = ["produto.status = 1", "produto.codigo_categoria = 1"];
...
<div class="offcanvas offcanvas-end site-cart" tabindex="-1" id="carrinhoProdutos" aria-labelledby="carrinhoProdutosTitulo">
        ...
        <div class="container">
            <nav>
                ...
                <ul id="navegacao">
                    ...
                    <li>
                        <a href="#" class="linkmenu">calçados</a>
                    </li>
                    <li>
    ...
    <section id="banner">
        <img src="assets/img/produtos/Rectangle 168.jpg" alt="">
    </section>
    <!-- Fim banner -->
    ...
    <section id="ofertas">
        <div class="container">
            <div id="text-off">
                <h2>Calçados</h2>
                <p>Chuteiras, tênis de corrida, tênis de couro, tênis para o dia a dia e sapatos, aqui você encontra
                    todas
                    as coleções de calçados, para escolher a sua marca favorita.</p>
            </div>
                ...
                ?>
                    <div id="btn-off">
                        ...
                        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                            ...
                            <div class="offcanvas-body">
                                <form method="GET" action="produtos.php" id="form-filtro">
                                   ...
                                   <div class="accordion-item">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapsefour" class="accordion-collapse collapse">
                                            <div class="accordion-body">
                                                <?php
                                                $sql_categoria = "SELECT codigo_categoria, nome FROM categoria WHERE codigo_categoria = 1";
                        ...
                        <form method="GET" action="produtos.php" id="form-ordenar">
