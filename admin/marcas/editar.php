              ...
              <form action="acoes.php" method="post">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input type="text" name="marca" id="marca" class="form-control" maxlength="40" value="<?php echo $marca['nome'] ?>" required>
                  </div>
                  ...
                  <div class="col-12 mt-2">
                    ...
                    <textarea name="observacao" id="observacao" class="form-control" maxlength="100" value="<?php echo $marca['observacao'] ?>"><?php echo $marca['observacao'] ?></textarea>
