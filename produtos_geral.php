...
// Query string dos filtros atuais (sem a página) para reaproveitar na paginação
$paramsPaginacao = $_GET;
unset($paramsPaginacao['page']);
$queryStringFiltros = http_build_query($paramsPaginacao);
$separadorFiltros = $queryStringFiltros ? '&' . $queryStringFiltros : '';
// ===================== FIM FILTROS =====================
...
<div class="offcanvas offcanvas-end site-cart" tabindex="-1" id="carrinhoProdutos" aria-labelledby="carrinhoProdutosTitulo">
                            ...
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                                ...
                                <div class="offcanvas-body">
                                    ...
                                    if (empty($_SESSION['carrinho'])) {
                                        ...
                                        foreach ($_SESSION['carrinho'] as $codigo => $qtdeCarrinho) {

                                            $sqlCarrinho = "SELECT * FROM produto WHERE codigo_produto = " . (int) $codigo;
                                            $queryCarrinho = mysqli_query($conexao, $sqlCarrinho);

                                            if ($produtoCarrinho = mysqli_fetch_assoc($queryCarrinho)) {
                                    ?>

                                                <div class="produto-carrinho mb-3 d-flex gap-3">

                                                    <img style="width: 120px; aspect-ratio: 1/1; object-fit: cover;"
                                                        src="/info_52/pi/images/produto/<?php echo $produtoCarrinho['foto']; ?>">

                                                    <div class="flex-grow-1">

                                                        <h6 style="font-size: 16px;">
                                                            <?php echo $produtoCarrinho['nome']; ?>
                                                        </h6>

                                                        <p style="font-size: 14px;">
                                                            Quantidade: <?php echo $qtdeCarrinho; ?>
                                                        </p>

                                                        <p style="font-size: 14px;">
                                                            R$ <?php echo number_format($produtoCarrinho['preco_venda'], 2, ',', '.'); ?>
                                                        </p>
    ...
    <section id="banner">
        <img src="assets/img/produtos/Geral.png" alt="">
    </section>
    <!-- Fim banner -->
    ...
    <section id="ofertas">
        <div class="container">
            <div id="text-off">
                <h2>Produtos</h2>
                <p>Roupas, tênis, acessórios e muito mais. Aqui você encontra uma coleção completa de produtos para renovar o seu estilo e escolher as suas marcas favoritas.</p>
            </div>
                ...
                ?>
                    <div id="btn-off">
                        ...
                        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                            ...
                            <div class="offcanvas-body">
                                <form method="GET" action="produtos_geral.php" id="form-filtro">
                                                    ...
                                                    echo '
                                                      <div class="form-check">
                                                          <input 
                                                              ...
                                                              id="cat_cat_' . $categoria['codigo_categoria'] . '"
                                                              ' . $categoriaMarcada . '
                                                          >
                                                          <label class="form-check-label" for="cat_cat_' . $categoria['codigo_categoria'] . '">
                                                              ' . $categoria['nome'] . '
                                                          </label>
                                                      </div>';
                                                }
                                ...
                                <div class="d-flex gap-2 mt-3 px-2">
                                    ...
                                    <a href="produtos_geral.php" class="btn btn-outline-secondary">Limpar</a>
                                </div>
                                </form>
                            </div>
                        </div>

                        <form method="GET" action="produtos_geral.php" id="form-ordenar">
            ...
            <nav aria-label="paginacao">
                <ul class="pagination justify-content-center">
                    <?php if ($paginaAtual != $paginaInicial) { ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo $url . $paginaInicial . $separadorFiltros ?>">Início</a>
                        </li>
                    <?php } ?>

                    <?php if ($paginaAtual >= 2) { ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo $url . $paginaAnterior . $separadorFiltros ?>" aria-label="Previous">
                    ...
                    <?php if ($paginaAtual < $paginaFinal) { ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo $url . $paginaProxima . $separadorFiltros ?>" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>

                        <li class="page-item">
                            <a class="page-link" href="<?php echo $url . $paginaFinal . $separadorFiltros ?>">Final</a>
                        </li>
                    <?php } ?>
                </ul>
            <?php } ?>
